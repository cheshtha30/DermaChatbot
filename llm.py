...
class ReplicateLLM:
    ...
    def add_message(self,msg):
        ...
        # print("Original"+self.prompt)
        # print("From messages"+self.getPromptFromMessages())
    ...
    def respond(self, query):
        ...
        "prompt": self.prompt,
        "temperature": self.kwargs.get("temperature", 0.75),
        "system_prompt": self.system_prompt,
        "max_new_tokens": self.kwargs.get("max_new_tokens", 500),
